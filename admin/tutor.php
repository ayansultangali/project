...
<a href='tutor.php?do=logout'>Выйти из сайта</a>
...
" ;?>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="login">
      <form method="post" action="new_tutor.php">
...
<p><select name="experience">
		...
		<select name="class" style='width:280px'>
		...
		<p><input type="submit" name="submit" value="Зарегистрировать"></p>
		</form>
    </div>
