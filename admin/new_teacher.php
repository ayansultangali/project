 ...
 if (isset($_POST['IIN'])) { $id = $_POST['IIN']; } 
	...
	mysql_connect ("localhost","root","");
		...
		$res = mysql_query ("INSERT INTO teacher (iin_t,surname,name,father,gender,birthday,phone,adress,mail,experience,education,nationality,class,password) VALUES ('$id','$surname','$name','$father','$gender','$date','$phone','$adress','$mail','$experience','$education','$nationality','$class','$password')");
	 if ($res=='TRUE')
	{
