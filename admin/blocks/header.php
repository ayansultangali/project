    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="students.php"><span>Ученики</span></a></li>
          <li><a href="tutor.php"><span>Кураторы</span></a></li>
          <li><a href="parent.php"><span>Родители</span></a></li>
          <li ><a href="teacher.php"><span>Учителя</span></a></li>
		  <li ><a href="doska_p.php"><span>Доска почета</span></a></li>
        </ul>		
      </div>
	  <div style="
	  position:absolute;
