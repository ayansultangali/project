 ...
 if (isset($_POST['IIN'])) { $id = $_POST['IIN']; } 
	...
	if (isset($_POST['sfamily'])) { $sfamily = $_POST['sfamily'];  } 
	
	mysql_connect ("localhost","root","");
        mysql_select_db ("users");
		mysql_query("set names utf8"); 
		$res = mysql_query ("INSERT INTO uchenik (iin_s,surname,name,father,gender,birthday,phone,adress,email,nationality,class,password,sfamily) VALUES ('$id','$surname','$name','$father','$gender','$date','$phone','$adress','$mail','$nationality','$class','$password','$sfamily')");
	 if ($res=='TRUE')
	{
