...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Наши достижения</span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="post_content">   
		  <table border="0" width="100%" align="left" cellpadding="3px" style="color:black; background-color:#fff; padding-left:5px;">
 <tr><th width="25%" style="background-color:#ccc; text-align:left;">Фамилия ученика</th>
 <th width="25%" style="background-color:#ccc;  text-align:left;">Имя ученика</th>
 <th width="25%" style="background-color:#ccc;  text-align:left;">Отчество ученика</th>
 <th width="25%" style="background-color:#ccc;  text-align:left;">Класс</th></tr>
  <?php
...
mysql_query("set names utf8");
	...
	$query = mysql_query("SELECT * FROM uchenik INNER JOIN doska_p ON uchenik.iin_s=doska_p.iin_s");
	if($query === FALSE) { 
    die(mysql_error());
}
